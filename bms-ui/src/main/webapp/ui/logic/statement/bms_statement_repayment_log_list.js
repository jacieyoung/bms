...
var listTemplate = '#bms_statement_repayment_log_list';
var formSearchTemplate = '#bms_statement_repayment_log_searchForm';
var formSearchTemplate_id = 'bms_statement_repayment_log_searchForm';
var gridMenuId = '#bms_statement_repayment_log_list_menu';
//当前用户需要特殊处理的按钮，不在menubar上显示的 
var metaData = {
		objectId:'bms_statement_repayment_log_list',
		objectName:'还款日志',
		...
		objectFields:
				[
                    ...
                    {field:'hxje',name:'还款金额',ctrlType:'easyui-numberbox',hidden:false},
                    {field:'syje',name:'剩余金额',ctrlType:'easyui-numberbox',hidden:false},
                    {field:'hxr',name:'核销人',ctrlType:'easyui-validatebox',hidden:true},
                    {field:'hxr_name',name:'核销人',ctrlType:'easyui-validatebox',hidden:false},
                    {field:'cjzgzl',name:'冲借支工作流',ctrlType:'easyui-validatebox',hidden:false},
				],
		actionForms:{
			'bms_statement_repayment_log_addData':{formId:'bms_statement_repayment_log_add_form',formUrl:'ui/view/statement/bms_statement_repayment_log_add_form.html?actionId=bms_statement_repayment_log_add_form'},
			'bms_statement_repayment_log_getData':{formId:'bms_statement_repayment_log_query_form',formUrl:'ui/view/statement/bms_statement_repayment_log_query_form.html?actionId=bms_statement_repayment_log_query_form'},
			'bms_statement_repayment_log_updateData':{formId:'bms_statement_repayment_log_update_form',formUrl:'ui/view/statement/bms_statement_repayment_log_update_form.html?actionId=bms_statement_repayment_log_update_form'}
			},
		expellActions:{
			'bms_statement_repayment_log_searchData':'',
			'bms_statement_repayment_log_exportEntities':''
			}
...
var bda_data_str_field = {
            bms_statement_repayment_log_addData : function (buttonId,actionUrl){
            ...
            bms_statement_repayment_log_deleteData : function (buttonId,actionUrl){
            ...
            bms_statement_repayment_log_exportData : function (buttonId,actionUrl){
            ...
            bms_statement_repayment_log_getData : function (buttonId,actionUrl){
            ...
            bms_statement_repayment_log_importData : function (buttonId,actionUrl){
            	var form = {};							
            ...
            bms_statement_repayment_log_searchData : function (buttonId,actionUrl){
				var params = $$.serializeToJson(formSearchTemplate);
				var conditions = [];
				var search;
            ...
            bms_statement_repayment_log_updateData : function (buttonId,actionUrl){
			var selectRow = $$.getSingleSelectRow(metaData.objectId, "请选择你要编辑的"+metaData.objectName);
		    	if(selectRow){
					...
					techParam.initActionUrl = appId + authActions['bms_statement_repayment_log_getData'];
					techParam.initActionId = 'bms_statement_repayment_log_getData';
					techParam.actionId = form.formId;
					techParam.mode = 'edit';
					techParam.refActionUrl = actionUrl;
					techParam.refActionId = buttonId;
