...
var metaData = {
		...
		objectFields:
				[
				{field:'serial_no',name:'流水号',ctrlType:'easyui-validatebox',hidden:false},
				{field:'lcbh',name:'流程编号',ctrlType:'easyui-validatebox',hidden:false},
				{field:'hkrq',name:'还款日期',ctrlType:'easyui-datebox',hidden:false},
				{field:'hkfs',name:'还款方式',ctrlType:'easyui-validatebox',hidden:false},
...
var searchMeta = [
				{field:'serial_no',name:'流水号',ctrlType:'easyui-validatebox',ddicTable:'',domainId:'',searchFlag:'=',mustFlag:'Y',defaultValue:''},
];
