...
public class BMS_statement_repayment_logData {
    ...
    public String getHxr_name() {
        return hxr_name;
    }

    public void setHxr_name(String hxr_name) {
        this.hxr_name = hxr_name;
    }
}
