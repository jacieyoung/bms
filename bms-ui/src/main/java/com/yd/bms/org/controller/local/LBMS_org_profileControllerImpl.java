...
import com.yd.bms.org.constant.BMS_org_profileConstant;
...
@Component
public class LBMS_org_profileControllerImpl implements BMS_org_profileController {

    // 机构信息Service
    @Autowired
    protected BMS_org_profileService dataService;
     ...
     ******************************************************************/
    public CIPResponseMsg addData(BMS_org_profile_addVO vo) {
     ...
     ******************************************************************/
    public CIPResponseMsg deleteData(BMS_org_profileKey key) {
     ...
     ******************************************************************/
    public CIPResponseMsg getData(BMS_org_profileKey key) {
        ...
        try {
            if (!StringUtils.isEmpty(templateName)) {
                ...
                if (templateFile.exists()) {
                    ...
                    SXSSFWorkbook wb = ExcelSheetParser.createWorkBook(templateName, BMS_org_profileConstant.getExcelTitle(), null);
                    wb.write(out);
                }
    ...
    public CIPResponseMsg updateData(HttpServletRequest request) {
        ...
        try {
            if (xAuth) {
                ...
                BMS_org_profileKey keys = JSONUtils.convertDataJson2Object(parameter.keys, BMS_org_profileKey.class);
    ...
    public CIPResponseMsg loadAllOrg(HttpServletRequest request) {
        ...
        CIPResponseMsg msg = new CIPResponseMsg();
        try {
            msg.data = dataService.loadAllOrg();
        } catch (Exception e) {
            log.error(e.getMessage(), e);
