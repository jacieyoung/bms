...
public class BMS_org_personPO {
    ...
    public void toVO(BMS_org_personKey obj) {
        obj.setPerson_id(person_id);
    }


    public void toVO(BMS_org_person_addVO obj) {
        obj.setPerson_id(person_id);
    ...
    public void toVO(BMS_org_person_queryVO obj) {
        obj.setPerson_id(person_id);
        obj.setPerson_code(person_code);
        obj.setPerson_status(person_status);
        obj.setPerson_type(person_type);
    ...
    public void toVO(BMS_org_person_updateVO obj) {
        obj.setPerson_id(person_id);
        obj.setPerson_code(person_code);
        obj.setPerson_status(person_status);
        obj.setPerson_type(person_type);
