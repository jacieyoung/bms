...
import com.yd.bms.org.constant.BMS_org_personConstant;
import com.yd.bms.org.controller.BMS_org_personController;
...
@Component
public class LBMS_org_personControllerImpl implements BMS_org_personController {

    // 人员信息Service
    @Autowired
    protected BMS_org_personService dataService;
     ...
     ******************************************************************/
    public CIPResponseMsg addData(BMS_org_person_addVO vo) {
     ...
     ******************************************************************/
    public CIPResponseMsg deleteData(BMS_org_personKey key) {
     ...
     ******************************************************************/
    public CIPResponseMsg getData(BMS_org_personKey key) {
        ...
        try {
            if (!StringUtils.isEmpty(templateName)) {
                ...
                if (templateFile.exists()) {
                    ...
                    SXSSFWorkbook wb = ExcelSheetParser.createWorkBook(templateName, BMS_org_personConstant.getExcelTitle(), null);
                    wb.write(out);
                }
    ...
    public CIPResponseMsg loaderData(HttpServletRequest request) {
        ...
        CIPResponseMsg msg = new CIPResponseMsg();
        try {
            msg.data = dataService.getDomain(tableId, domainId);
        } catch (Exception e) {
            log.error(e.getMessage(), e);
    ...
    public CIPResponseMsg updateData(HttpServletRequest request) {
        ...
        try {
            if (xAuth) {
                ...
                BMS_org_personKey keys = JSONUtils.convertDataJson2Object(parameter.keys, BMS_org_personKey.class);
