...
@RestController(value="BMS_statement_repaymentController")
@RequestMapping(value = "/actions/bms_statement_repayment")
public class BMS_statement_repaymentControllerImpl  implements BMS_statement_repaymentController{
    ...
    // 本地控制实现
    @Autowired
    private BMS_statement_repaymentController actionComponent;
