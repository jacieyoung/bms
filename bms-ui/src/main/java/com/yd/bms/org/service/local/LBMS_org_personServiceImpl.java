...
import com.yd.bms.org.service.impl.BMS_org_personServiceImpl;
...
@Service(value = "BMS_org_personServiceImpl")
public class LBMS_org_personServiceImpl extends BMS_org_personServiceImpl {
    ...
    public String exportData(String exportPath, CIPReqCondition[] conditions, CIPRuntimeOperator user) {
        ...
        if (os.startsWith("win") || os.startsWith("Win")) {
            ...
            // 2. 生成文件名
            fileName = exportPath + File.separator + "BMS_org_person"
            ...
            try {
                ...
                fileName = "BMS_org_person" + DateUtils.getDate(new Date());
                String cmd = null;
...
//        return super.getDomain(tableId, domainId);
        //todo lly
        return null;
    }
    ...
    public void importData(File file, CIPRuntimeOperator user) {
        ...
        List<BMS_org_personPO> pos = new ArrayList<BMS_org_personPO>();
        ...
        try {
            ...
            Field field;
            Map<String, String> titles = BMS_org_personConstant.getExcelTitle();
            int j = 0;
            Set<String> columns;
            String typeName;
